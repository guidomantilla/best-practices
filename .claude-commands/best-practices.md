...
If the user asked the slash command with extra context (e.g. "/best-practices for this Terraform module"), suggest 1–2 skills from the list that best match that context after showing the catalog.
